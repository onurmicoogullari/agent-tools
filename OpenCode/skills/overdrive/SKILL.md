...
Use `question` when available; otherwise ask in chat. Keep required decisions in the main session and wait for the answer before dependent work. Reuse answers already provided in the conversation.

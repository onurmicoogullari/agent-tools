#!/usr/bin/env python3
"""
Fetch all PR conversation comments, reviews, and inline review threads for the
PR associated with the current git branch.
...
def _ensure_gh_authenticated() -> None:
    try:
        ...
        raise RuntimeError("gh auth status failed") from None
...
def fetch_all(owner: str, repo: str, number: int) -> dict[str, Any]:
    ...
    while True:
        ...
        reviews_cursor = reviews_page["pageInfo"]["endCursor"] if reviews_page["pageInfo"]["hasNextPage"] else None

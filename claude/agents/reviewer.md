...
For code reviews, follow the engineering-review skill's scope, evidence, severity, and output rules when they differ from the general review guidance above.

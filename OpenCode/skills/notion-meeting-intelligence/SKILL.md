...
description: Prepare meeting materials with Notion context and OpenCode research; use when gathering context, drafting agendas/pre-reads, and tailoring materials to attendees.
metadata:
...
Prep meetings by pulling Notion context, tailoring agendas/pre-reads, and enriching with OpenCode research.
...
5) Enrich with OpenCode research (industry insights, benchmarks, risks) and update the page with `Notion:notion-update-page` as plans change.
...
- Add concise OpenCode research where helpful: market/industry facts, benchmarks, risks, best practices.

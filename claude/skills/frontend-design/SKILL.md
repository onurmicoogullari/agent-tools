...
**Gathering order:**
1. **Check the conversation and current instructions (instant)**: Reuse design context the user already supplied. If it covers the required context, or your loaded instructions contain a **Design Context** section, proceed immediately.

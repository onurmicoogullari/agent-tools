...
Evaluation scenarios for testing the Spec to Implementation skill across different OpenCode models.
...
- Creates tasks that OpenCode can implement with clear acceptance criteria

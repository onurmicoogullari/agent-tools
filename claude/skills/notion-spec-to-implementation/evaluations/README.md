...
Evaluation scenarios for testing the Spec to Implementation skill across different Claude Code models.
...
- Creates tasks that Claude Code can implement with clear acceptance criteria

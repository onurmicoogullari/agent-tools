...
Evaluation scenarios for testing the Research & Documentation skill across different OpenCode models.
...
- Distinguishes between Notion content and OpenCode research

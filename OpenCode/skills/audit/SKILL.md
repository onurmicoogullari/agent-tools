...
- **Suggested skill**: Which skill to load (prefer: animate, quieter, optimize, adapt, clarify, distill, delight, onboard, normalize, audit, harden, polish, extract, bolder, arrange, typeset, critique, colorize, overdrive — or other installed skills you're sure exist)
...
Map issues to available skills. Prefer these: animate, quieter, optimize, adapt, clarify, distill, delight, onboard, normalize, audit, harden, polish, extract, bolder, arrange, typeset, critique, colorize, overdrive. You may also suggest other installed skills you're sure exist, but never invent skills.
...
Load a recommended workflow with the native `skill` tool, for example `skill({ name: "normalize" })`.


## Input

Use the user's request for these arguments; do not invent missing values.

...
Evaluation scenarios for testing the Meeting Intelligence skill across different Claude Code models.

## Purpose

These evaluations ensure the Meeting Intelligence skill:
- Gathers context from Notion workspace
- Enriches with Claude Code research appropriately
- Creates both internal pre-reads and external agendas
- Distinguishes between Notion facts and Claude Code insights
...
- Enriches with Claude Code research (decision frameworks, migration best practices)
- Creates comprehensive internal pre-read with recommendation
- Creates clean, professional external agenda
- Clearly distinguishes Notion facts from Claude Code insights
...
- Adds Claude Code context (industry benchmarks, best practices)
...
3. Verify the skill searches Notion first (not Claude Code research)
4. Check that TWO documents are created (internal + external)
5. Verify Claude Code enrichment adds value without replacing Notion content
...
4. **Verify enrichment value** - Is Claude Code research genuinely helpful?
...
- "Claude Code enrichment includes decision frameworks or best practices"
